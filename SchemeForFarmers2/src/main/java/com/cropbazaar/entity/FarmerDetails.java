...
public class FarmerDetails {
	 ...
	 * @JsonIgnore
	 * 
	 * @OneToMany(mappedBy = "farmerDetails", cascade = CascadeType.ALL) private
	 * List<FarmerSellRequest> farmerSellRequest;
	 */
	...
	/*
	 * public List<FarmerSellRequest> getFarmerSellRequest() { return
	 * farmerSellRequest; }
	 * 
